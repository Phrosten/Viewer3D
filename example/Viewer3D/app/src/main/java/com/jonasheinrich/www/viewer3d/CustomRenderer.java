...
import com.jonasheinrich.www.viewer3d.Base.BodyMesh;
import com.jonasheinrich.www.viewer3d.Meshes.*;
...
public class CustomRenderer implements GLSurfaceView.Renderer
{
    ...
    {
        meshTypes = BodyMesh.Factory.GetList(new Class[]{GenericMesh.class});
    }
